...
describe('TodoTools', () => {
  it('displays number of items left', () => {
    const getActiveItems = 3
    const component = renderIntoDocument(
      <TodoTools getActiveItems={getActiveItems}/>
    )
  ...
  it('Highlight the active filter', () => {
    const filter = 'active'
    const component = renderIntoDocument(
  ...
  it('calls a callback when clicked on Clear Completed Buttons', () => {
    let cleared = false
